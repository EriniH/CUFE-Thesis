...
Figure~\ref{fig:math_mod_uml} illustrates the overall UML class diagram for the mathematical modeling architecture.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Figures/Ch5/mathematical_modeling.png}
    \caption{UML Class Diagram of the Mathematical Modeling Architecture.}
    \label{fig:math_mod_uml}
\end{figure}
